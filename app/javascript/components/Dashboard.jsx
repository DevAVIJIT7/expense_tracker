...
const Dashboard = ({ daily_expenses }) => (
  <>
          ...
          <div className="card shadow mb-4">
              ...
              <div className="card-body">
                  <div className="chart-area"><div className="chartjs-size-monitor"><div className="chartjs-size-monitor-expand"><div className=""></div></div><div className="chartjs-size-monitor-shrink"><div className=""></div></div></div>
                      {/* <canvas id="myAreaChart" style="display: block; height: 320px; width: 1043px;" width="2086" height="640" className="chartjs-render-monitor"></canvas> */}
                      <BarChart chart_data={daily_expenses} />
                  </div>
              </div>
          </div>
      </div>
